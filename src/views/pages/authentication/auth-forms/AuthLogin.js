        ...
        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
          <form noValidate onSubmit={handleSubmit} {...others}>
            ...
            {/* <Grid container style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '5px', marginBottom: '10px' }}>
              <Grid item>
                <Typography variant="subtitle1">
                  ...
                  <a href="https://serpdog.io/terms" target="_blank" rel="noreferrer">
                    Terms & Condition.
                  </a>
                </Typography>
              </Grid>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1}>
              ...
              <Typography variant="subtitle1" component={Link} to="/forgot-password/" color="secondary" sx={{ textDecoration: 'none', cursor: 'pointer' }}>
                 Forgot Password?
               </Typography>
            </Stack>
